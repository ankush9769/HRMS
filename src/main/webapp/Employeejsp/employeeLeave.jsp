...
<main class="glass-page">
    <section class="glass-hero">
        <div class="glass-hero-grid">
            <div>
                <div class="glass-kicker"><i class="bi bi-calendar-heart"></i> Leave requests</div>
                <h1 class="glass-title">Plan time off with <span>less friction</span></h1>
                <p class="glass-subtitle">Submit a leave request, then review your queue in a glass table with status chips and clean approval actions preserved from the existing backend.</p>
                <div class="glass-actions">
                    <a class="glass-btn" href="#request-form"><i class="bi bi-pencil-square"></i> Apply now</a>
                    <a class="glass-btn glass-btn-secondary" href="#leave-table"><i class="bi bi-list-check"></i> View requests</a>
                </div>
            </div>
